...
class WasmAidoku: WasmModule {
    ...
    func export(into namespace: String = "aidoku") {
        globalStore.export(named: "create_manga", namespace: namespace, block: self.create_manga)
        globalStore.export(named: "create_manga_result", namespace: namespace, block: self.create_manga_result)
        globalStore.export(named: "create_chapter", namespace: namespace, block: self.create_chapter)
        globalStore.export(named: "create_page", namespace: namespace, block: self.create_page)
        globalStore.export(named: "create_deeplink", namespace: namespace, block: self.create_deeplink)
    }
}
...
extension WasmAidoku {
    ...
    var create_manga: @convention(block) (
    ...
    var create_manga_result: @convention(block) (Int32, Int32) -> Int32 {
    ...
    var create_chapter: @convention(block) (
        Int32, Int32, Int32, Int32, Float32, Float32, Float64, Int32, Int32, Int32, Int32, Int32, Int32
    ) -> Int32 {
    ...
    var create_page: @convention(block) (Int32, Int32, Int32, Int32, Int32, Int32, Int32) -> Int32 {
    ...
    var create_deeplink: @convention(block) (Int32, Int32) -> Int32 {
        { manga, chapter in
