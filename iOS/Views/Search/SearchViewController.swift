...
class SearchViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let sectionProvider: UICollectionViewCompositionalLayoutSectionProvider = { sectionIndex, environment in
            ...
            let groupSize = NSCollectionLayoutSize(widthDimension: .estimated(120), heightDimension: mangaCount > 0 ? .estimated(180) : .absolute(0))
        ...
        collectionView?.register(MangaCarouselHeader.self, forSupplementaryViewOfKind: "header", withReuseIdentifier: "MangaCarouselHeader")
...
extension SearchViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        if kind == "header" {
            var headerView = collectionView.dequeueReusableSupplementaryView(ofKind: kind, withReuseIdentifier: "MangaCarouselHeader", for: indexPath) as? MangaCarouselHeader
            if headerView == nil {
