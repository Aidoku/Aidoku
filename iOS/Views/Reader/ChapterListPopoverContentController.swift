...
protocol ChapterListPopoverDelegate {
...
class ChapterListPopoverContentController: UIViewController {
    ...
    var delegate: ChapterListPopoverDelegate?
...
//        tableView?.register(UITableViewCell.self, forCellReuseIdentifier: "UITableViewCell")
        ...
        tableView?.separatorColor = .label.withAlphaComponent(0.2) //UIColor(white: 1, alpha: 0.2)
    }
